    ...
    <article v-else-if="currentArticle" class="article-content">
      ...
      <footer class="article-footer">
        ...
        <div class="article-share">
          ...
          <button class="share-btn" @click="shareTo('wechat')" title="分享到微信">
            <svg viewBox="0 0 24 24" fill="currentColor">
              <path d="M8.691 2.188C3.891 2.188 0 5.476 0 9.53c0 2.212 1.17 4.203 3.002 5.559v3.646l3.07-1.677c.76.212 1.563.328 2.399.328.344 0 .68-.023 1.008-.067-.135-.453-.203-.93-.203-1.414 0-3.36 2.695-6.086 6-6.086.485 0 .962.068 1.416.203.043-.328.067-.664.067-1.008 0-4.053-3.891-7.342-8.691-7.342zM21.53 9.281c1.312 0 2.375 1.196 2.375 2.672 0 1.477-1.063 2.672-2.375 2.672-1.313 0-2.375-1.195-2.375-2.672 0-1.476 1.062-2.672 2.375-2.672zm-8.342 5.344c1.312 0 2.375 1.195 2.375 2.672 0 1.476-1.063 2.672-2.375 2.672-1.312 0-2.375-1.196-2.375-2.672 0-1.477 1.063-2.672 2.375-2.672z"/>
            </svg>
          </button>
